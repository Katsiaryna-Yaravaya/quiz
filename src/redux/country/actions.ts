...
export const clearAllAnsweredQuestions = createAction("[Results] CLEAR_ALL_ANSWERED_QUESTIONS");
...
export const currentUserIndex = createAction<number>("[Quiz] CURRENT_USER_INDEX");
